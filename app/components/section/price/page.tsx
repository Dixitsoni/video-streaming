import Header2 from '@/app/layout/header2/Header2'
    ...
    return (
        <>
            <div className="bg-white relative">
                ...
                <div className="bg-white pt-30 sm:pt-32">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        ...
                        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                            <div className="p-8 sm:p-10 lg:flex-auto">
                                <h3 className="text-2xl font-bold tracking-tight text-gray-900">Users is less than 1000</h3>
                ...
                <div className="bg-white pt-5 sm:pt-5">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        ...
                        <div className="mx-auto mt-5 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-5 lg:mx-0 lg:flex lg:max-w-none">
                            <div className="p-8 sm:p-10 lg:flex-auto">
                                <h3 className="text-2xl font-bold tracking-tight text-gray-900">Users is less than 1000</h3>
                                <p className="mt-6 text-base leading-7 text-gray-600">Lorem ipsum dolor sit amet consect etur adipisicing elit. Itaque amet indis perferendis blanditiis repellendus etur quidem assumenda.</p>
                                <div className="mt-10 flex items-center gap-x-4">
