    ...
    return (
        ...
        <svg className="w-[100px] h-[100px] text-orange-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className='p-10 drop-shadow-2xl drop-shadow-xl'>
                <h1 className='text-3xl text-orange-500 font-bold'>Get Started with a 30-Days Trial for FREE !</h1>
                <h1 className='text-3xl mt-1 text-orange-500 font-bold'>Video Hosting, Video Streaming and<br/>Live Streaming</h1>
                <div className=''>
            ...
            <div className='drop-shadow-2xl transition ease-in-out hover:scale-110 border-2 p-3 bg-orange-300 rounded-2xl cursor-pointer'>
                <div className='flex items-center'>
                    ...
                    <span className='text-1xl ml-5 font-bold'>Upload & Add Videos on your site/app with DRM & Watermark!</span>
                ...
                <div className='mt-4 flex items-center'>
                    ...
                    <span className='text-1xl ml-5 font-bold'>Google Widevine DRM Encryption & Watermark Security</span>
                </div>
                <div className='mt-4 flex items-center'>
                    <svg className="w-6 h-6 text-green-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm13.707-1.293a1 1 0 0 0-1.414-1.414L11 12.586l-1.793-1.793a1 1 0 0 0-1.414 1.414l2.5 2.5a1 1 0 0 0 1.414 0l4-4Z" clip-rule="evenodd" />
                    ...
                    <span className='text-1xl ml-5 font-bold'>5 GB Bandwidth, 4 Videos limit</span>
                </div>
                <div className='mt-4 flex items-center'>
                    <svg className="w-6 h-6 text-green-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm13.707-1.293a1 1 0 0 0-1.414-1.414L11 12.586l-1.793-1.793a1 1 0 0 0-1.414 1.414l2.5 2.5a1 1 0 0 0 1.414 0l4-4Z" clip-rule="evenodd" />
                    ...
                    <span className='text-1xl ml-5 font-bold'>All Integration Plugins, APIs, SDK</span>
                </div>
                <div className='mt-4 flex items-center'>
                    <svg className="w-6 h-6 text-green-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm13.707-1.293a1 1 0 0 0-1.414-1.414L11 12.586l-1.793-1.793a1 1 0 0 0-1.414 1.414l2.5 2.5a1 1 0 0 0 1.414 0l4-4Z" clip-rule="evenodd" />
                    ...
                    <span className='text-1xl ml-5 font-bold'>Global AWS CDN & Hosting</span>
                </div>
