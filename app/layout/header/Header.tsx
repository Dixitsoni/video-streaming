        ...
        <header className="">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    <div className="relative">
                        ...
                        <div id='drop-down' className="absolute lg:hidden bg-slate-800 -left-8 top-full z-10 mt-3 w-80 max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                            <div className="p-4">
                                ...
                                <div className="group relative flex items-center gap-x-6 rounded-lg text-sm leading-6 hover:bg-gray-600">
                                    <div className="flex h-11 w-11 flex-none items-center justify-center bg-slate-800 rounded-lg bg-gray-50 group-hover:hover:bg-gray-600">
                                        {/* <svg className="h-6 w-6 text-gray-600 group-hover:text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"> */}
                                        {/* <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" /> */}
                                        {/* </svg> */}
                                        <svg className="w-[22px] h-[28px] text-white dark:text-white hover:bg-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">PRICE</a>
                </div>
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900 p-2 rounded-lg bg-sky-300 hover:bg-sky-500">Log in <span aria-hidden="true">&rarr;</span></a>
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900 border-2 p-2 rounded-lg bg-white-500 ml-5 hover:text-white hover:bg-gray-900">Signup <span aria-hidden="true">&rarr;</span></a>
                </div>
            </nav>
